...
<script type="text/template" id="_nc-connect-facebook-profile-dialog">
	...
	<div class="nc-network-type-dialog nc-networks">
		...
		$url = esc_url( $url );
		?>
		<div class="nc-network nc-facebook-personal">
			<div class="nc-logo" data-href="<?php echo $url; ?>" title="<?php
				echo esc_attr_x( 'Facebook Personal Profile', 'text', 'nelio-content' );
			?>"></div>
			<?php echo esc_html_x( 'Personal', 'text (facebook)', 'nelio-content' ); ?>
		</div><!-- .nc-facebook-personal -->
