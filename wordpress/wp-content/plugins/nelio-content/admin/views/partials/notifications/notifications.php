	...
	<div class="nc-followers">
		...
		[* if ( 0 === amountOfFollowers ) { *]
			<div class="nc-no-followers">
				<?php
					echo esc_html_x( 'Select the users that should receive email notifications when the status of this post is updated, when an editorial task is created or completed, or when an editorial comment is added.', 'user', 'nelio-content' );
				?>
			</div><!-- .nc-no-followers -->
		[* } *]
