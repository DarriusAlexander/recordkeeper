...
function sunshine_shipping_method( $echo=true, $raw=false ) {
	...
	if ( $raw ) {
		...
		if ( isset( $sunshine->cart->shipping_method['id'] ) )
			$shipping_method = sunshine_money_format( $sunshine->shipping->get_shipping_method_cost( $sunshine->cart->shipping_method['id'] ), false );
		else {
...
?>
	...
	<?php if ( isset( $sunshine->options['tax_location'] ) && $sunshine->options['tax_location'] != '' && isset( $sunshine->options['tax_rate'] ) && $sunshine->options['tax_rate'] != '' ) { ?>
